	...
	<body>
		<div class="backdrop">
			...
			<div class="buttons">
				<ul class="menu-bar">
					...
					<li><button class="btn" tabindex="-1"> <a class="button-text" href="contact.html"><span class="active-page">Contact</span></a></button></li>
        ...
        <div class="footer">
            ...
            <ul class="footer-menu">
                ...
                <li><button class="footer-button" tabindex="-1"><a class="footer-button-text" href="contact.html"><span class="active-page">Contact</span></a></button></li>
            </ul>
